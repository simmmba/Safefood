	...
	<section id="services" class="section-bg">
		<div class="container">
			...
			<header class="section-header">
				<h3>회원 정보 수정</h3>
				<form class="form-horizontal" action="edit.food" method="post">
					...
					<div class="form-group has-feedback row">
						<label for="inputLastName"
							class="col-md-3 control-label text-md-right col-form-label">기존 비밀번호
							<span class="text-danger small">*</span>
						</label>
						<div class="col-md-8">
					...
					<div class="form-group has-feedback row">
						<label for="inputLastName"
							class="col-md-3 control-label text-md-right col-form-label">새 비밀번호
							<span class="text-danger small">*</span>
						</label>
						<div class="col-md-8">
							<input type="password" class="form-control" id="inputLastName"
