...
public class ExpectedIntake {
    private String ino,id,code;
    ...
    public ExpectedIntake(String ino, String idate, String id, String code, int count) {
		this.ino = ino;
		this.id = id;
		this.code = code;
		this.count = count;
	...
	public String toString() {
		return "Intake [ino=" + ino + ", id=" + id + ", code=" + code + ", name=" + name
